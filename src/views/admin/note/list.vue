  ...
  <div class="app-container calendar-list-container">
    ...
    <el-table @selection-change="collectId" :data="noteData" v-loading="listLoading" element-loading-text="努力加载中..." border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column  label="状态" >
          ...
          <el-switch v-model="scope.row.status" @change="changeNoteStatus(scope.row.id,scope.row.status)"></el-switch>
          </template>
      </el-table-column>
...
import {listadmin,changeStatus,deleteNote} from "@/api/note"
