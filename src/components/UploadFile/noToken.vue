<template>
  <div>
    ...
    <span class="imgTips" v-if="!disabled && fileType === 'image'">支持jpg、png格式，文件小于2M</span>
...
import { imgHost, imgUploadfx, imgUploadType, limitImage } from '@/utils/config'
...
export default {
  ...
  methods: {
    ...
    handleSuccess(res) {
      ...
      this.$emit('success', res.body.path)
    },
    // 上传前校验
    beforeUpload(file) {
